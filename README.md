...
>  如有问题请直接在 Issues 中提，或者您发现问题并有非常好的解决方案，欢迎 留言

>  开发环境 Win10  Chrome 80  nodejs 13.4.0

# 技术栈

## vue2、vuex、webpack、nodejs/npm、less、es6、ajax、rem

# 项目运行（nodejs 6.0+）
``` bash
# 克隆到本地
git clone https://github.com/YYZ2013/vue2+vuex.git
